...
class Create_Order_Lubricant extends StatefulWidget {
  static const Color contentColorOrange = Color(0xFF00705B);
  final Color leftBarColor = Color(0xFFCB6600);
  final Color rightBarColor = Color(0xFF5BECD2);
  @override
  _CreateOrderLubricantState createState() => _CreateOrderLubricantState();
}

class _CreateOrderLubricantState extends State<Create_Order_Lubricant> {
  int hsd = 350;
  int hobc = 330;
  int pmg = 332;
  int hsdt = 0;
